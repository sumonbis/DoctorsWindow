...
import com.bablabd.library.DatabaseHandler;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				docEmail= inputEmail.getText().toString();
				...
				try {
					FileOutputStream fOut = openFileOutput("doctorsemal", MODE_PRIVATE);
					fOut.write(docEmail.getBytes());
